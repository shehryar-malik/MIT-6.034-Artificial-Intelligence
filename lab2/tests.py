...
def hill_climbing_6_testanswer(val, original_val = None):
    ...
    return (elapsed < 5) #intentionally removed from brackets: and val[-1] == hill_climbing_test_6_goal
...
def a_star_5_testanswer(val, original_val = None):
    ...
    return (elapsed < 1) # intentionally left and val[-1] == a_star_test_5_goal)
